class FormsController < ApplicationController
  ...
  private
    ...
    def form_params
      params.require(:form).permit(:form_id, :acquired_or_disposed_code, :nature_of_ownership, :code, :shares, :security_title, :direct_or_indirect_code, :form_type, :equity_sqap_invloved, :transaction_date, :shares_after, :price_per_share)
    end
end
